...
const ModalCard = ({ bankName, fintechUseNo, tofintechno }) => {
  ...
  const genTransId = () => {
    ...
    let transId = "M202201559U" + countnum; //이용기과번호 본인것 입력
    return transId;
  };
  ...
  const deposit = () => {
    const twoLeggedToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJNMjAyMjAxNTU5Iiwic2NvcGUiOlsib29iIl0sImlzcyI6Imh0dHBzOi8vd3d3Lm9wZW5iYW5raW5nLm9yLmtyIiwiZXhwIjoxNjY4MDYyMjMzLCJqdGkiOiI3YTg3ZDJjOC1hYTk0LTQ0MTMtOGY4NS1jNzgzMTY0ODk2MTMifQ.M0rweuk6Ra72zn2x2Jq6cvU4uwClzD14AO3zTiSNYOs"
    /**
     * #Last Work
     * 입금이체 작성해 주세요 !
     * 2legged token 사용 !
